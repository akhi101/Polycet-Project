define(['app'], function (app) {
    app.controller("DashboardController", function ($scope, $stateParams, $localStorage, $state, AppSettings, SystemUserService, AdminService, PreExaminationService) {
        ...
        if (authData == undefined) {
            ...
            $scope.logOut = function () {
                ...
                var getNotifications = AdminService.logoutUser($scope.userName);
                getNotifications.then(function (response) {
