    ...
    public class StudentCertificateController : ApiController
    {
           ...
           try
            {
                ...
                //{
                    ...
                    param[0] = new SqlParameter("@ExaminationCentreCode", request["ExaminationCentreCode"]);                    
                    ...
                    respdfList.Add(new GetInterimRes { PdfUrl = pdfurl, Pin = request["ExaminationCentreCode"].ToString() });
                //}      
        ...
        public async Task<object> GetMigrationCertificate([FromBody] JsonObject request)
        {
            try
            {
                ...
                //{
                //var jobject = JsonConvert.DeserializeObject<JsonObject>(JsonConvert.SerializeObject(js[i]));                   
                param[0] = new SqlParameter("@HallticketNumber", request["HallticketNumber"]);
                DataSet ds = dbHandler.ReturnDataWithStoredProcedure("SP_Get_RankcardDetails", param);  //USP_SS_GET_FeePaidInteriamCertificateDetails
                GenerateCertificate GenerateCertificate = new GenerateCertificate();
                //var HallTicketNo = ds.Tables[1].Rows[0]["HallTicketNo"].ToString();
                var pdfurl = GenerateCertificate.GetMigrationCertificate(ds);
                respdfList.Add(new GetInterimRes { PdfUrl = pdfurl, Pin = request["HallticketNumber"].ToString() });
        ...
        <div>";
            ...
            page += $@"<div class='container'>
                <div class='marginData'>
                    <div class='row'>
                        <div class='col-md-10'>
                            <div><b>TS POLYCET Hall Ticket No :</b></div>
                        </div>
                        <div class='col-md-2'>
