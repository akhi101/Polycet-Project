...
<b class='border_btm'>{{FatherName == null ? '______________':FatherName}}</b>
        ...
        public string GetInterimCertificate(DataSet IntrmData)
        {
            ...
            var AbsentiesCount = DataTableHelper.ConvertDataTable<AbsentiesCount>(IntrmData?.Tables[1]).ToArray();
            var MalpracticeCount = DataTableHelper.ConvertDataTable<MalpracticeCount>(IntrmData?.Tables[2]).ToArray();
            var dir = AppDomain.CurrentDomain.BaseDirectory + @"Reports\UnsignedCert\";
            CreateIfMissing(dir);
            string html = @"<html>"
                   + "<head>"
...
font-size:13px!important;
                            ...
                            <div class='row'>
                                ...
                                <div class='col-md-10 title'>
                                    ...
                                    <h4 class='text-center'>
                                       <b>POLYCET – 2022 Consolidated Attendance</b>
                                    </h4>
            ...
            page += $@"  <div class='container'>
                    ...
                    <div class='marginData'>
                        <div class='row'>
                            <div class='col-md-12'>
                                <div style='line-height: 2.0;font-size:14px!important;'><b class='border_btm'>Examination Centre </b>: {InterimData[0].ExaminationCentre ?? "-"}.</div>                               
                            </div>
                            <div class='col-md-12'>
                                <div style='line-height: 2.0;font-size:14px!important;'><b class='border_btm'>Date and Time of Examination </b>: {InterimData[0].ExamDate ?? "-"} {InterimData[0].ExamTime ?? "-"} .</div>                               
                            </div>
                            <div class='col-md-12'>
                                <div style='line-height: 2.0;font-size:14px!important;'><b class='border_btm'>Number of the Candidates allotted to the Centre </b>: {InterimData[0].AllotedCount ?? "-"}.</div>                               
                            </div>
                            <div class='col-md-12'>
  ...
  <div class='col-md-12'>
                                <div style='line-height: 2.0;font-size:14px!important;'><b class='border_btm'>Hall Ticket numbers of Absentees </b>:";
 ...
 <div class='col-md-12'>
                                <div style='line-height: 2.0;font-size:14px!important;'><b class='border_btm'>Hall Ticket numbers of Malpractice cases </b>:";
...
<div class='col-md-12'>
            ...
            var doc = converter.ConvertHtmlString(sbString);
            var path = dir + "AttendanceReport_" + InterimData[0].ExaminationCentreCode + ".pdf";
            doc.Save(path);
            doc.Close();
            string relativePath = path.Replace(HttpContext.Current.Request.PhysicalApplicationPath, GetWebAppRoot()).Replace(@"\", "/");
            return relativePath;
...
<div class='row length'>
        ...
        {
            List<MigrationData> MigrationData = MigrationDat.Tables[0].DataTableToList<MigrationData>().ToList(); ;
            var dir = AppDomain.CurrentDomain.BaseDirectory + @"Reports\UnsignedCert\";
            CreateIfMissing(dir);
            string html = @"<html>"
                   + "<head>"
 ...
 <div class='container'>
         ...
         <div class='row'>
            ...
            <div class='col-md-8 title'>
                ...
                <h6 class='text-center'>Polycet Common Entrance Test For Admission into Polytechnics</h6>
            </div>
            <div class='col-md-2 logo '>
                <div class='logo-image' style='padding:6px!important;'>
        ...
        <div>";
            ...
            page += $@"<div class='container'>
                <div class='marginData'>
                    <div class='col-md-12'>
                            <div class='col-md-6'>
                                <div>TS POLYCET Hall Ticket No: {MigrationData[0].HallTicketNo ?? "-"}.</div>       
                                <div>Name: {MigrationData[0].Name ?? "-"}.</div>
<div>Father's Name: {MigrationData[0].FatherName ?? "-"}.</div>
<div>Date of Birth: {MigrationData[0].DateofBirth ?? "-"}.</div>
<div>Date of Examination: {MigrationData[0].ExamDate ?? "-"}.</div>
                            </div>
                       <div class='col-md-6'>
                                <div>Engineering Stream State Rank: {MigrationData[0].MPC_RANK ?? "-"}.</div>  
                                <div>Agricalture Stream State Rank: {MigrationData[0].MBIPC_RANK ?? "-"}.</div>
<div> <table class='table'>
                                    <thead>
                                      <tr>
                                        <th class='text-center' colspan='4' >Marks Secured</th>
                                     ...
                                     <tr>
                                        ...
                                        <th class='text-center cln' > Biology </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class='text-center'  >{MigrationData[0].MATHS ?? "-"}</th>
                                        <td class='text-left'  >{MigrationData[0].PHYSICS ?? "-"}</th>
                                        <td class='text-left '  >{MigrationData[0].CHEMISTRY ?? "-"}</th>
                                        <td class='text-center cln' > {MigrationData[0].BIOLOGY ?? "-"} </th>
                                    </tr>
                                </tbody>";
            page += @"<tbody><table></div></div></div></div>
                            ";
            #endregion
            ...
            var doc = converter.ConvertHtmlString(sbString);
            var path = dir + MigrationData[0].HallTicketNo + ".pdf";
            doc.Save(path);
            doc.Close();
            string relativePath = path.Replace(HttpContext.Current.Request.PhysicalApplicationPath, GetWebAppRoot()).Replace(@"\", "/");
            return relativePath;
        ...
        public async Task<string> GetC18odcHTMLByPin(C18OdcTrSheet studentdata)
        {
            ...
            if (studentdata.Semester == "6SEM")
            {
                tmphtmlpage += $@"   <tr>
                            ...
                            <td></td>
                            <td colspan='35' style='text-align:left;'>ODC NO : {studentdata.ODCNO} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CMG NO : {studentdata.CMGNO} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; IndustryName :  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Division : {studentdata.Division} 
