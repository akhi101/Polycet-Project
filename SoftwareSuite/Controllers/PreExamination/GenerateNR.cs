            ...
            foreach (var bc in distinctBarcodes)
            {
                ...
                else
                {
                    ...
                    var page = $@"<br /><br /><div class='col-sm-12 col-md-12 col-lg-12'>
                                ...
                                <h5 class='text-center'><b>Attendance sheet cum signature statement of the candidates present for POLYCET - 2022</b></h5>
                            </div>
...
<table>
 ...
 <td  id='tbl_head1'><b>Name of the Candidate</b></td> 
      ...
      <td td rowspan='2'>{students[i].Name}</td>
                                <td >{students[i].fname}
</td>
                                <td   rowspan='2'>{students[i].sex}</td>
                                <td  rowspan='2'>
                                    <img src='{studentPhotoDir + students[i].HallticketNumber + ".jpg"}' style='border: 2px solid #ddd;margin:5px;' height='120' width='100' />
                                </td>
                                <td>
<img src='{studentSignDir + students[i].HallticketNumber + ".jpg"}' style='border: 2px solid #ddd;margin:5px;;' height='45' width='150' />
</td>
								</tr>
