    ...
    [HttpGet, ActionName("GenerateWantings")]
        ...
        public string UpdateExamCenters([FromBody] JsonObject data)
        {
            try
            {
                ...
                param[0] = new SqlParameter("@UserLoginName", data["UserLoginName"]);
                param[1] = new SqlParameter("@ExaminationCentreID", data["ExaminationCentreID"]);
                param[2] = new SqlParameter("@ExaminationCentreName", data["ExaminationCentreName"]);
                param[3] = new SqlParameter("@ExaminationCentreTypeID", data["ExaminationCentreTypeID"]);
                param[4] = new SqlParameter("@ExaminationCentrePhone", data["ExaminationCentrePhone"]);
                param[5] = new SqlParameter("@ExaminationCentreCapacity", data["ExaminationCentreCapacity"]);
                param[6] = new SqlParameter("@Active", data["Active"]);
                var dt = dbHandler.ReturnDataWithStoredProcedure("SP_Update_ExaminationCentres", param);
        ...
        public string GetExamCentersExcel(string UserLoginName)
        {
            List<person> p = new List<person>();
            person p1 = new person();
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    string filename = "Examination" + "-" + "Centers" + "_" + Guid.NewGuid() + ".xlsx";
...
#pragma warning restore CS0162 // Unreachable code detected
        ...
        [HttpPost, ActionName("SetExamCenters")]
        public string SetExamCenters([FromBody] JsonObject request)
        {
            try
            {
                var dbHandler = new dbHandler();
                var param = new SqlParameter[5];
                param[0] = new SqlParameter("@ExaminationCentreName", request["ExaminationCentreName"]);
                param[1] = new SqlParameter("@ExaminationCentreTypeID", request["ExaminationCentreTypeID"]);
                param[2] = new SqlParameter("@ExaminationCentrePhone", request["ExaminationCentrePhone"]);
                param[3] = new SqlParameter("@ExaminationCentreCapacity", request["ExaminationCentreCapacity"]);
                param[4] = new SqlParameter("@UserLoginName", request["UserLoginName"]);
                var dt = dbHandler.ReturnDataWithStoredProcedure("SP_Add_ExaminationCentre", param);
        ...
        public string GenerateOtpForFeedback(string Pin, int FeedbackId)
        {
            ...
            try
            {
                ...
                {
                    string urlParameters = "?mobile=" + dt.Tables[1].Rows[0]["Phone"] + "&message=" + Message + "&templateid=1007161786863825790"; ;
                    HttpClient client = new HttpClient();
                    client.BaseAddress = new Uri(url);
                    client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                    HttpResponseMessage response = client.GetAsync(urlParameters).Result;
        ...
        public string GetWebSiteVisiterCount()
        {
            try
            {
                ...
                var dt = dbHandler.ReturnDataWithStoredProcedure("USP_GET_WebSiteVisiterCount", param);
                return JsonConvert.SerializeObject(dt);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet, ActionName("GetExaminationCentreTypes")]
        public HttpResponseMessage GetExaminationCentreTypes()
        {
            try
            {
                var dbHandler = new dbHandler();
            ...
            catch (Exception ex)
            {
                ...
                dbHandler.SaveErorr("SP_Get_ExaminationCentreTypes", 0, ex.Message);
                return Request.CreateResponse(HttpStatusCode.InternalServerError, ex.Message);
            }
        }
        ...
        public string GetExamCenters(string UserLoginName)
        {
            try
            {
                var dbHandler = new dbHandler();
                var param = new SqlParameter[1];
                param[0] = new SqlParameter("@UserLoginName", UserLoginName);
                var dt = dbHandler.ReturnDataWithStoredProcedure("SP_Get_ExaminationCentres ", param);
                return JsonConvert.SerializeObject(dt);
            }
            catch (Exception ex)
            {
