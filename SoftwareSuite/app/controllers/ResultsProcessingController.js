define(['app'], function (app) {
    app.controller("ResultsProcessingController", function ($scope, $http, $localStorage, $rootScope, $state, $stateParams, $document, AppSettings, $timeout, PreExaminationService) {
        ...
        $scope.$watch('myfile1', function (newFileObj) {
            if (newFileObj) {
                $scope.filename1 = newFileObj.name;
                //$scope.FileContains = true;
                $scope.FileContains1 = true;
            }
        });
        ...
        $scope.openExcel1 = function () {
            ...
            if ($scope.myfile1 != '') {
                ...
                reader1.readAsBinaryString($scope.myfile1);
