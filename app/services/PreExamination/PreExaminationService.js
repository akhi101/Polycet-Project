define(['app'], function (app) {
    app.service("PreExaminationService", function (DataAccessService) {
        ...
        this.GetExamCenters = function (UserLoginName) {
            var paramObject = {
                "UserLoginName": UserLoginName
            };
            return DataAccessService.getDataWithPara('api/PreExamination/GetExamCenters', paramObject);
        };

        this.GetExamCentersExcel = function (UserLoginName) {
            var paramObject = {
                "UserLoginName": UserLoginName
            };
            return DataAccessService.getDataWithPara('api/PreExamination/GetExamCentersExcel', paramObject);
        };
        ...
        this.GetExaminationCentreTypes = function () {
            return DataAccessService.getDataAll('api/PreExamination/GetExaminationCentreTypes');
        };
        ...
        this.SetExamCenters = function (ExaminationCentreName, ExaminationCentreTypeID, ExaminationCentrePhone, ExaminationCentreCapacity, UserLoginName) {
            var paramObject = {
                ...
                "ExaminationCentrePhone": ExaminationCentrePhone, "ExaminationCentreCapacity": ExaminationCentreCapacity, "UserLoginName": UserLoginName
            };
